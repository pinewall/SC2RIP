...
!-----------------------------------------------------------------------
      ...
      do n = 1, grid1_size
        print 1024, n, grid1_area(n), grid1_frac(n)
 1024 format(i6,2x,f9.6,2x,f9.6)
      enddo
      do n = 1, grid2_size
        print 1024, n, grid2_area(n), grid2_frac(n)
      enddo
!-----------------------------------------------------------------------
!
...
!-----------------------------------------------------------------------
      ...
      print *, "output weights before write_remap"
      print *, "num_links_map1: ", num_links_map1
      open(unit=86, file="weights.scrip", form="binary", 
     &          status="replace")
      write (86), wts_map1
      close(unit=86)
