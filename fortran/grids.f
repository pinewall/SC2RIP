...
!-----------------------------------------------------------------------
      ...
      open(unit=86, file="grid_info.scrip", 
     &      status="replace", form="binary")
      !write(86) -pih
      !write(86) deg2rad
      write(86) grid1_center_lat
      write(86) grid1_center_lon
      write(86) grid1_corner_lat
      write(86) grid1_corner_lon

      write(86) grid2_center_lat
      write(86) grid2_center_lon
      write(86) grid2_corner_lat
      write(86) grid2_corner_lon
      close(unit=86)
!-----------------------------------------------------------------------
!
